...
class PlatformSpec extends Specification {
    ...
    def "creates platform from wdk config map"() {
        ...
        [labels: null, testEnvironment: null, testLabels: null, dockerArgs: null]         | true   | buildVersion("os", "v")       | new Platform("v", ".", "v", "macos", false, "", [], [], true, false)
        [checkDir: "dir"]                                                                 | false  | buildVersion("os2", "v")      | new Platform("v", "dir", "v", "macos", false, "", [], [], false, false)
        ...
        [clearWs: true]                                                                   | false  | buildVersion("os3", "v")      | new Platform("v", ".", "v", "macos", false, "", [], [], false, true)
        [testEnvironment: ["t=a", "t2=b"]]                                                | false  | buildVersion("os", "v")       | new Platform("v", ".", "v", "macos", false, "", ["t=a", "t2=b"], [], false, false)
        [testEnvironment: ["t=a", "t2=b"], testLabels: ["l", "l2"]]                       | true   | buildVersion("os", "v")       | new Platform("v", ".", "v", "macos", false, "", ["t=a", "t2=b"], ["l", "l2"], true, false)
        [labels: "label", testLabels: ["t", "t2"]]                                        | false  | buildVersion("os4", "v")      | new Platform("v", ".", "v", "macos", false, "label", [], ["t", "t2"], false, false)
        [labels: "label", testLabels: [v: ["t", "t2"]]]                                   | false  | buildVersion("os", "v")       | new Platform("v", ".", "v", "macos", false, "label", [], ["t", "t2"], false, false)
        [labels: "label", testLabels: [v: "tag"]]                                         | false  | buildVersion("os", "v")       | new Platform("v", ".", "v", "macos", false, "label", [], ["tag"], false, false)
        [labels: "label", testLabels: [notv: ["t", "t2"]]]                                | false  | buildVersion("os5", "v")      | new Platform("v", ".", "v", "macos", false, "label", [], [], false, false)
        [labels: "label", testEnvironment: [v: ["t=a", "t2=b"]]]                          | false  | buildVersion("os", "v")       | new Platform("v", ".", "v", "macos", false, "label", ["t=a", "t2=b"], [], false, false)
        [labels: "label", testEnvironment: [notv: ["t=a", "t2=b"]]]                       | false  | buildVersion("os", "v")       | new Platform("v", ".", "v", "macos", false, "label", [], [], false, false)
        [labels: "label", testEnvironment: ["t=a", "t2=b"]]                               | false  | buildVersion("os", "v")       | new Platform("v", ".", "v", "macos", false, "label", ["t=a", "t2=b"], [], false, false)
        [labels: "label", testEnvironment: ["t=a", "t2=b"], testLabels: ["l", "l2"]]      | false  | buildVersion("os6", "v")      | new Platform("v", ".", "v", "macos", false, "label", ["t=a", "t2=b"], ["l", "l2"], false, false)
        [labels: "label", testEnvironment: ["t=a", "t2=b"], testLabels: ["l", "l2"]]      | false  | buildVersion("os", "v", "lv") | new Platform("v_lv", ".", "v", "macos", false, "label", ["t=a", "t2=b"], ["l", "l2"], false, false)
        [labels: null, testEnvironment: null, testLabels: null, dockerArgs: [not: "nul"]] | false  | buildVersion("os", "v")       | new Platform("v", ".", "v", "macos", false, "", [], [], false, false)
        [labels: null, testEnvironment: null, testLabels: null, dockerArgs: [not: "nul"]] | false  | buildVersion("os", "v", "lv") | new Platform("v_lv", ".", "v", "macos", false, "", [], [], false, false)
    }
